...
if (isset($_POST["OrderPaymentType"]) && ($_POST["OrderPaymentType"] == "BILLINGDETAILS")) {
	...
	@header("Location: checkout_step4.php");
	 ...
	 $OrderPaymentType=$_SESSION['OrderPaymentType']		=isset($_POST['OrderPaymentType'])?$_POST['OrderPaymentType']:"";// Set Order Billing Type to Pay on Delivery
...
<div id="checkout_data_entry_sections" class="DataEntryForm">
 ...
 <form action="checkout_step3_en.php" method="post" name="frmPayOnDelivery" id="frmPayOnDelivery">
...
<form action="checkout_step3_en.php" method="post" name="frmBillingDetails" id="frmBillingDetails">
    ...
    <p>&nbsp;</p>
      <table width="100%" align="center">
        ...
        <tr valign="baseline">
          <td><input type="text" name="FirstName" id="FirstName3" value="<?php echo $BillingFirstName;?>" size="32"  placeholder="FirstName" /></td>
          <div id="FirstNameValidation" class="validation_message"> </div>
          <td><input type="text" name="LastName" id="LastName3" value="<?php echo $BillingLastName;?>" size="32"  placeholder="LastName" /></td>
        	<div id="LastNameValidation" class="validation_message"> </div>
        </tr>
        <tr valign="baseline">
          <td><input type="text" name="AddressLine1" id="AddressLine3" value="<?php echo $BillingAddressLine1;?>" size="32"  placeholder="AddressLine1" /></td>
        ...
        <tr valign="baseline">
          <td><input type="text" name="City" id="City3" value="<?php echo $BillingCity;?>" size="32"  placeholder="City" /></td>
...
?>
        ...
        <tr valign="baseline">
          <td><input type="text" name="Phone" id="Phone3" value="<?php echo $BillingPhone;?>" size="32"  placeholder="Phone" /></td>
         	<div id="PhoneValidation" class="validation_message"> </div>
          <td><input type="text" name="Email" id="Email3" value="<?php echo $BillingEmail;?>" size="32"  placeholder="Email" /></td>
    ...
    <tr valign="baseline">
      <td width="50%"><div class="select_combo">
        <select name="CreditCardType" id="CreditCardType3" class="SelectBox">
    ...
    <tr valign="baseline">
      <td><input type="text" name="CreditCardNo" id="CreditCardNo3" value="<?php echo $BillingCreditCardNo;?>"   placeholder="Credit Card Number" /></td>
      <div id="CreditCardNoValidation" class="validation_message"> </div>
      <td><input type="text" name="CreditCardSecurityCode" id="CreditCardSecurityCode3" value="<?php echo $BillingCreditCardSecurityCode;?>" size="32"  placeholder="Credit Card Security Code" /></td>
    ...
    <tr valign="baseline">
      ...
      <td><input name="CreditCardExpiryYear" type="text" value="<?php echo $BillingCreditCardExpiryYear;?>" id="CreditCardExpiryYear" size="8" placeholder="Expiry Year"/></td>
    	<div id="CreditCardExpiryYearValidation" class="validation_message"> </div>
    </tr>
    <tr valign="baseline">
      <td>&nbsp;</td>
