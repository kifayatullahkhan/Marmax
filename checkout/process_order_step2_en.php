...
if ((isset($_POST["checkout_process"])) && ($_POST["checkout_process"] == "SHIPMENTDETAILS")) {
	...
	@header("Location: checkout_step3_en.php");
...
<div id="checkout_data_entry_sections"  class="DataEntryForm">
  <form action="checkout_step2_en.php" method="post" name="frmAddShipmentDetails" id="frmAddShipmentDetails">
    <div class="box_like_section_wrapper">
    <h2>Shipment Contact</h2>
   	  <p>&nbsp; </p>
    <table width="100%" align="center">
      <tr valign="baseline">
        <td><input type="text" name="FirstName" id="FirstName2" value="<?php echo $ShipmentFirstName; ?>" size="32" placeholder="First Name"/></td>
        <div id="FirstNameValidation" class="validation_message"> </div>
        <td><input name="LastName" type="text" id="LastName2" value="<?php echo $ShipmentLastName; ?>" size="32" placeholder="Last Name" /></td>
      	<div id="LastNameValidation" class="validation_message"> </div>
      </tr>
      <tr valign="baseline">
        <td><input type="text" name="Phone" id="Phone2" value="<?php echo $ShipmentPhone; ?>" size="32" placeholder="Phone" /></td>
        <div id="PhoneValidation" class="validation_message"> </div>
        <td><input type="text" name="Email" id="Email2" value="<?php echo $ShipmentEmail; ?>" size="32" placeholder="Email"/></td>
    ...
    <table width="100%" align="center">
      <tr valign="baseline">
        <td width="50%"><input type="text" name="AddressLine1" id="AddressLine2" value="<?php echo $ShipmentAddressLine1; ?>" size="32"  placeholder="Address Line 1"/></td>
       	<div id="AddressLine1Validation" class="validation_message"> </div>
        <td width="50%"><input type="text" name="AddressLine2" value="<?php echo $ShipmentAddressLine2; ?>" size="32"  placeholder="Address Line 2"/></td>
      </tr>
      <tr valign="baseline">
        <td><input type="text" name="City" id="City2" value="<?php echo $ShipmentCity; ?>" size="32"  placeholder="City" /></td>
...
?>
      ...
      <tr valign="baseline">
        <td><input type="text" name="CompanyNameIfAny" value="<?php echo $ShipmentCompanyNameIfAny; ?>" size="32"  placeholder="Company Name"/></td>
        <td><input type="checkbox" name="IsBusinessAddress" value="<?php echo $ShipmentIsBusinessAddress; ?>" />
          IsBusinessAddress:</td>
      </tr>
      </table>
      ...
      <tr valign="baseline">
        <td width="48%"><div class="select_combo">
          <select name="ShipmentMethod" class="SelectBox">
            <option value="Standard Shipment" <?php if (!(strcmp("Standard Shipment", "$ShipmentShipmentMethod"))) {echo "SELECTED";} ?>>Standard Shipment</option>
            <option value="Eramax" <?php if (!(strcmp("Eramax", "$ShipmentShipmentMethod"))) {echo "SELECTED";} ?>>Eramax</option>
            <option value="FedEx" <?php if (!(strcmp("FedEx", "$ShipmentShipmentMethod"))) {echo "SELECTED";} ?>>FedEx</option>
            <option value="Van Delivery" <?php if (!(strcmp("Van Delivery", "$ShipmentShipmentMethod"))) {echo "SELECTED";} ?>>Van Delivery</option>
          </select>
        </div></td>
        <td width="52%"><input name="btnNext" type="submit" id="btnNext" value="Next" class="button_misbah"/></td>
      </tr>
    </table>
        <p>&nbsp;</p>
</div>
