...
<h2>Create Account</h2>
  ...
  ?>">
        ...
        <table width="100%" border="0" cellspacing="5" cellpadding="5">
         <tr>
            <td width="50%"><input type="text" name="FirstName" id="FirstName1" accesskey="f" tabindex="1" placeholder="First Name"  /></td>
            <div id="FirstNameValidation" class="validation_message"> </div>
            <td width="50%"><input type="text" name="LastName" id="LastName1" accesskey="l" tabindex="2" placeholder="Last Name"/></td>
            <div id="LastNameValidation" class="validation_message"> </div>
       
          </tr>
        
          <tr>
            <td width="50%"><input type="text" name="SignUpEmail" id="SignUpEmail1" accesskey="e" tabindex="3" placeholder="email"  /></td>
            <div id="SignUpEmailValidation" class="validation_message"> </div>
            <td width="50%"><input type="text" name="SignUpConfirmEmail" id="SignUpConfirmEmail1" accesskey="c" tabindex="4" placeholder="confirm email"/></td>
          	<div id="SignUpConfirmEmailValidation" class="validation_message"> </div>
          </tr>
          <tr>
            <td><input type="password" name="SignUpPassword" id="SignUpPassword1" accesskey="p" tabindex="5" placeholder="password" /></td>
            <div id="SignUpPasswordValidation" class="validation_message"> </div>
            <td><input type="password" name="SignUpConfirmPassword" id="SignUpConfirmPassword1" accesskey="o" tabindex="6" placeholder="password confirm"/></td>
            <div id="SignUpConfirmPasswordValidation" class="validation_message"> </div>
          </tr>
          <tr>
            <td colspan="2" align="center" valign="middle"><input name="btnSubmit2" type="submit" tabindex="7" value="Create Account" class="button_misbah" /></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
...
$(document).ready(function() {
 ...
 <!-------End Of Validation By Ghufran ----------->
  ...
  ?>">
   <table width="100%" border="0" cellspacing="5" cellpadding="5">
     <tr>
       <td><input type="text" name="SigninEmail" id="SigninEmail1" accesskey="f" tabindex="8" placeholder="email" /></td>
     	<div id="SigninEmailValidation" class="validation_message"> </div> 
     </tr>
     <tr>
       <td><input type="password" name="SigninPassword" id="SigninPassword1" accesskey="p" tabindex="9" placeholder="password"/></td>
     	<div id="SigninPasswordValidation" class="validation_message"> </div> 
     </tr>
     <tr>
       <td><input name="btnSubmit" type="submit" tabindex="10" value="Login" class="button_misbah" /></td>
     </tr>
     <tr>
       <td>&nbsp;</td>
     </tr>
