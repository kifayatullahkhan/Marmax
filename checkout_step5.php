...
<div id="page_default_center_width">
    ...
    <div id="page_contents" class="gradient  round_borders">
      <?php
	   ...
	   require_once("checkout/process_order_step5_ar.php");
...
<!-- Start of Footer Include -->
	 ...
	 require_once("php_code_files/cms_web_page_read_sections/page_footer_inc_ar.php"); 
...
<!-- Start of jQuery Script Inc --> 
		...
		require_once("front_end_include_files/footer_jquery_scripts_inc.php"); ?>
