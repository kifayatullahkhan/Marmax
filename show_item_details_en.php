...
if(!isset($_GET['InvItemID'])){
	header("Location: index_en.php"); // Jump back to the previous page
}
...
<div style="clear:both"> </div>
	...
	<!-- Start of SearchMenuBar -->
     <?php require_once('php_code_files/cms_web_page_read_sections/search_and_menu_bar_inc_en.php'); ?>
   	<!-- End of SearchMenuBar -->
	
    <!-- Start of DropDownMenu -->
    <div id="DropDownMenu">
     <?php 
	   require_once('php_code_files/virtual_stores/show_categories_and_its_sub_categories_en.php');	    ?>
    </div>
    <div class="clear_all"></div>    
   	<!-- End of DropDownMenu -->
...
<!-- Start of sign_in_form -->
    ...
    <?php require_once("php_code_files/virtual_stores/show_item_details_en.php"); ?>
