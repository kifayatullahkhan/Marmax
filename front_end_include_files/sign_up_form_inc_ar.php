    ...
    <div class="contant_wrapper"> 
      ...
      <legend class="legend">الاشتراك مستخدم</legend>
      <fieldset>
         <label>
        الاسم الاول
        <input type="text" name="FirstName" id="FirstName" accesskey="e" tabindex="1" placeholder="First Name"  />
        <div id="FirstNameValidation" class="validation_message"> </div>
      </label>
       <label>
        الاسم الاخير
         <input type="text" name="LastName" id="LastName" accesskey="c" tabindex="2" placeholder="Last Name"/>
