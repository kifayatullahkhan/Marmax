...
<div id="logo">
           ...
           <div id="tabs">
             <ul>
               <li><a href="index.php?CONTENT_TYPE=DEALS"  class="deals" id="BtnDeals"><div id="lblDeals">الصفقات</div></a></li>
               <li><a href="index.php?CONTENT_TYPE=VS"  class="virtual_stores" id="BtnVirtualStores"><div id="lblVirtualStores">الأسواق الالكترونية</div></a></li>
             </ul>
           </div>
           <!-- End of Tabs -->
           ...
           <?php if(isset($_SESSION) && isset($_SESSION['MM_Username'])) {  
           		   if(isset($_SESSION['MM_UserGroup']) && $_SESSION['MM_UserGroup']==1){
						...
						if(file_exists("admin_zpanel/admin_session_menu_ar.php")) 
						require_once("admin_zpanel/admin_session_menu_ar.php"); 
						else
						if(file_exists("../admin_zpanel/admin_session_menu_ar.php")) 
						require_once("../admin_zpanel/admin_session_menu_ar.php"); 
				   }
						...
						if(file_exists("user_cpanel/user_session_menu_ar.php")) 
						require_once("user_cpanel/user_session_menu_ar.php");
						else  
						if(file_exists("../user_cpanel/user_session_menu_ar.php")) 
						require_once("../user_cpanel/user_session_menu_ar.php"); 	
					}
