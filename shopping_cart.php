...
<div style="clear:both"> </div>
   <!-- Start of news -->
    ...
    <?php require_once('php_code_files/news_ticker_management/news_get_ticker_ar.php'); ?>
    </div>
    <!-- End of news-->
    ...
    <?php require_once("php_code_files/virtual_stores/show_category_items_ar.php"); ?>
