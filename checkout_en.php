...
// If User Already Signed In, then redirect him to step 2
if(isset($_SESSION['MM_UserGroup'])&& isset($_SESSION['MM_UserID']) ){
	 header("Location: checkout_step2_en.php");  								 
}
$_SESSION['ln']="en";
?>
<!DOCTYPE HTML>
...
<div id="page_default_center_width">
    ...
    <div id="page_contents" class="gradient  round_borders">
      <?php require_once("checkout/process_order_step1_en.php"); ?>
    </div>
