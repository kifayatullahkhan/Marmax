                 ...
                 <div id="UserDetailsMenuList">
                         <ul>
                         	<li> 
                                  ...
                                  <a class="iframe" href="admin_zpanel_en.php">Control Panel</a></div>
                         	</li>
                           <li>
                                 <div id="change_password_icon"> </div>
                                 <div class="cpanel_link_title"><a href="admin_zpanel_en.php?page_name=admin_change_password">Change Password</a></div>
                            </li>
                           <li>
                                 <div id="shopping_cart_icon"> </div>
                                 <div class="cpanel_link_title"><a href="dmin_zpanel_en.php?page_name=admin_change_users_password">Change User Password</a></div>
                            </li>
                           <li class="last"> 
