...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
   ...
   $insertSQL = sprintf("INSERT INTO vs_users_virtual_stores_inventory (UserID, VSInvItemCode, VSInvItemName, VSInvItemShortDescription, VSInvItemDescription, VSInvItemName2, VSInvItemShortDescription2, VSInvItemDescription2, ActualPrice, DescountPercentage, VSInvItemSalesPrice, VSStockPositionQuantity, VSWarningLevelStockPositionQty, VSItemCATID, VSItemSubCATID,  DisplayImage, GallaryImage1, GallaryImage2, GallaryImage3, GallaryImage4, GallaryImage5, GallaryImage6,TargetedGroupID,BrandID) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,  %s, %s)",
   ...
   <div class="DataEntryForm">
    ...
    <table width="100%">
        <tr valign="baseline">
          ...
          <td width="16%">SubCat:</td>
          <td width="28%">Item Code:</td>
          <td width="23%">Brand Name</td>
          <td width="18%">Targeted Group</td>
          </tr>
        <tr valign="baseline">
          <td><select name="VSItemCATID" id="VSItemCATID">
            <?php 
do {  
?>
