...
mysql_select_db($database_Conn, $Conn);
$query_rs_getuserprofile = sprintf("SELECT Username,FirstName, AddressLine1, AddressLine2, City, Country, Phone, Email, ContactNo, Others, Picture FROM user_accounts WHERE Username = %s", GetSQLValueString($colname_rs_getuserprofile, "text"));
