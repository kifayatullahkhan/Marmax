...
<form action="index.php?user_change_password" method="post" name="frmPasswordChange" id="frmPasswordChange">
  
<div class="DataEntryForm">
<div class="box_like_section_wrapper">
<h2>تغيير كلمة السر </h2>
<br>
         كلمة السر الحالية<br>
        ...
        تأكيد كلمة السر الجديدة<br>
         <input name="Password_confirm" type="password" id="Password_confirm" value="" size="32"  accesskey="c" tabindex="3" />
          ...
          <input type="submit" value="تغيير كلمة السر" name="btnChangePassword" class="button_misbah"/> 
