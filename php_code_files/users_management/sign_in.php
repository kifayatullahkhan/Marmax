...
if (isset($_POST['Username'])) {
  ...
  $MM_redirectLoginSuccess = "../../index.php?MSG=LOGINOK";
  $MM_redirectLoginFailed = "../../index.php?MSG=LOGINFAILED";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_Conn, $Conn);
  	
  $LoginRS__query=sprintf("SELECT UserID, Username, Password, GroupID FROM user_accounts WHERE Username=%s AND Password=%s",
