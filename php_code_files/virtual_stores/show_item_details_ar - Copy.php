...
$query_Rs_GetItemDetails = sprintf("SELECT * FROM vs_users_virtual_stores_inventory WHERE VSInvItemID = %s", GetSQLValueString($colname_Rs_GetItemDetails, "int"));
...
<div class="deals_buy_section">
	<div class="deals_buy_button">
		<div class="deals_buy_price">
          ريال<?php echo $row_Rs_GetItemDetails['VSInvItemSalesPrice']; ?>
        </div>
        <div class="other_deals_prices">
                <div class="detail">
                <h2>القيمة</h2>
                <h1><?php echo $row_Rs_GetItemDetails['ActualPrice']; ?></h1>
                </div>
          ...
          <div class="other_detail_section">
            ...
            <div class="wrapper">
           	  <h2>تنتهي الصفقة في<h2>
             <div id="DealsCountDownTimer"></div>
            </div>
          </div>
          <div class="other_detail_section_tall">
            <div class="wrapper">
            <h2>أكثر من 10 بيعت</h2>
            <h4>الكمية محدودة</h4>
            <div class="deal_is_on">هذه الصفقة متاحة<img src="images/checkmark.png" width="48" height="48" /></div>
            </div>
          </div>
          <!-- Store Logo -->
