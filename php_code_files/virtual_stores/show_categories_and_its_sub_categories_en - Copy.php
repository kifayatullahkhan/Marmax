...
<ul class="GlobalMenuItem">
  <?php do { ?>
 <li><a href="" golobalcatid="<?php echo $row_Rs_GetGlobalCategories['VSItemCATID']; ?>"  class="GlobalCategoryLink"><?php echo $row_Rs_GetGlobalCategories['VSItemCategoryName']; ?></a></li>
...
<?php require_once("ajax_get_sub_category_list_en.php"); ?>
</div>
...
<script type="text/javascript">
   ...
   $('.GlobalMenu a').click(function(event) {
		   ...
		   $.get("php_code_files/virtual_stores/ajax_get_sub_category_list_en.php?golobalcatid="+GlobalCatID, function(data){
