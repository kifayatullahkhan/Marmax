...
if(isset($_GET['SearchBoxText'])&& $_GET['SearchBoxText']!=="jQueryScript") {
	$query_Rs_Show_CategoryItems = sprintf("SELECT * FROM vs_users_virtual_stores_inventory WHERE VSItemSubCATID = %s OR vs_users_virtual_stores_inventory.VSInvItemName2 LIKE %s", GetSQLValueString($colname_Rs_Show_CategoryItems, "int"),GetSQLValueString("%".$SearchBoxText_Rs_Show_CategoryItems."%", "text"));
  ...
  if($totalRows_Rs_Show_CategoryItems>0){
   do { ?>
	...
	<div class="ItemDisplayBorder">
            <div class="ItemImage">
            <a href="show_item_details.php?InvItemID=<?php echo $row_Rs_Show_CategoryItems['VSInvItemCode']; ?>">
...
}elseif(file_exists("../shopping_cart/add_item_cart_jquery_inc_ar.php")) {
