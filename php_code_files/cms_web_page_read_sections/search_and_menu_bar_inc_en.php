...
<div id="SearchMenuBar">
	<div id="SearchBox">
    <form action="index_en.php" method="get" enctype="application/x-www-form-urlencoded" name="frmSearchBox" id="frmSearchBox">
...
<div class="MenuButton">
  <a href="#" ButtonName="ChooseCategory"> Choose Category</a></div>
</div>
