...
<div class="shopping_cart_form">
  ...
  <tr class="DarkHeaderRow">
    ...
    <th>Item Code</th>
    <th>Item Name</th>
    <th width="200" align="center" valign="middle">Quantity</th>
...
$totalRows_RsGetCartDetails = mysql_num_rows($RsGetCartDetails);
  ...
  <?php do { ?>
    <tr>
      ...
      <td width="200" align="center" valign="middle"><form action="php_code_files/shopping_cart/update_item_quantity_in_cart_en.php" method="post" id="frmUpdateQty" name="frmUpdateQty">
      ...
      <td align="center" valign="middle"><form action="php_code_files/shopping_cart/remove_item_from_cart_en.php" method="post" name="formRemoveItem" id="formRemoveItem">
