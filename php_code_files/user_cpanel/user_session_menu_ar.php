                 ...
                 <div id="UserDetailsMenuList">
                         <ul>
                         	<li> 
                                  ...
                                  <a class="iframe" href="index_ar.php?page_name=user_profile">صفحة المستخدم</a></div>
                         	</li>
                           <li>
                                 <div id="change_password_icon"> </div>
                                 <div class="cpanel_link_title"><a href="index_ar.php?page_name=user_change_password">تغيير كلمة المرور</a></div>
                            </li>
                           <li>
                                 <div id="shopping_cart_icon"> </div>
                                 <div class="cpanel_link_title"><a href="index_ar.php?page_name=show_my_orders">عرض الطلبات</a></div>
                            </li>
                           <li class="last"> 
