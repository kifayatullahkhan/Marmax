...
$query_Rs_GetItemDetails = sprintf("SELECT * FROM vs_coupons WHERE CouponID = %s", GetSQLValueString($colname_Rs_GetItemDetails, "int"));
...
<div class="deals_buy_section">
	<div class="deals_buy_button">
		<div class="deals_buy_price">
          SAR <?php echo $row_Rs_GetItemDetails['NewPrice']; ?>
        </div>
        <div class="other_deals_prices">
          ...
          <img src="user_uploads/files/deals_virtual_store_images/store_logos/<?php echo $row_Rs_GetItemDetails['StoreLogo']; ?>" width="226" height="120" /></div>
          <!-- End of Store Logo -->
  ...
  <div class="golden_ad">
   ...
   <img src="user_uploads/files/ads_images/sooqna_ad2.jpg" width="250" height="270" />
	...
	<div class="vs_item">
            ...
            <?php echo $row_Rs_GetItemDetails['CouponName2']; ?>
            </div> <!-- End of vs_item_title -->
            
            <div class="vs_item_short_description">
             <?php echo $row_Rs_GetItemDetails['CouponShortDescription2']; ?>
    	...
    	<div id="wrapper">
            ...
            <?php 
             ...
             <?php } ?>
                ...
                <!-- End of item_image -->
                    <form method="GET" action="php_code_files/shopping_cart/add_item_to_cart.php" name="form1" id="form1">
 					<input name="InvItemID" type="hidden" id="ItemID" size="3"  value="<?php echo $colname_Rs_GetItemDetails; ?>"/>
                     <input name="Quantity" type="text" size="5" maxlength="5" value="1">
                     <input name="ItemCartType" type="hidden" size="5" maxlength="5" value="CouponDeals"> 
                    <input name="btnAddToCart" type="submit" value="أضف الى السلة" id="btnAddToCart"> 
                </form>
              ...
              <?php echo $row_Rs_GetItemDetails['CouponLongDescription2']; ?>
...
//alert(newYear);
$('#DealsCountDownTimer').countdown({until: NewUntilDate ,compact: true,format: 'dHMS'}); 
