...
$query_Rs_GetLatestNews = "SELECT NewsID, NewsTitle, NewsText, DATE_FORMAT(Dated,'%d %M %Y') as Dated, Username FROM news WHERE Language='en' ORDER BY NewsID DESC";
...
<ul id="js-news" class="js-hidden">
                  <?php do { ?>
                    	<li  class="news-item">
                         <a href="#"><?php echo $row_Rs_GetLatestNews['NewsTitle']; ?></a> &gt;&gt;
                         
                         <?php echo $row_Rs_GetLatestNews['NewsText']; ?> |
                         <?php echo  $row_Rs_GetLatestNews['Dated']; ?> 
